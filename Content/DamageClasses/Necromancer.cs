...
namespace necromancerclass.Content.DamageClasses
{
	public class Necromancer : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<Necromancer>() += 4;
			player.GetArmorPenetration<Necromancer>() += 2;
