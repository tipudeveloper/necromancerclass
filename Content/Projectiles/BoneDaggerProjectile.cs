using necromancerclass.Content.Items.Weapons;
...
namespace necromancerclass.Content.Projectiles
{
	...
	public class BoneDaggerProjectile : ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			Projectile.DamageType = ModContent.GetInstance<Necromancer>(); // Makes the projectile deal ranged damage. You can set in to DamageClass.Throwing, but that is not used by any vanilla items
