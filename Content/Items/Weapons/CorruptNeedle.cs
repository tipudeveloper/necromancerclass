using necromancerclass.Content.Projectiles;
...
{
	public class CorruptNeedle : ModItem
	{
		public override void SetDefaults() {
			...
			// Weapon Properties
			Item.DamageType = ModContent.GetInstance<Necromancer>(); // Sets the damage type to ranged.
			...
			// Gun Properties
			Item.shoot = ModContent.ProjectileType<CorruptNeedleProjectile>(); // For some reason, all the guns in the vanilla source have this.
